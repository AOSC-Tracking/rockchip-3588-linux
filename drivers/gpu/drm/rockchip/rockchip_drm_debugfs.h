...
static inline int
rockchip_drm_debugfs_add_vps_sync(struct drm_crtc *crtc, struct dentry *root)
{
	return 0;
}

static inline int
rockchip_drm_debugfs_add_vps_enable(struct drm_crtc *crtc, struct dentry *root)
{
	return 0;
}

static inline int
rockchip_drm_debugfs_add_vps_disable(struct drm_crtc *crtc, struct dentry *root)
{
	return 0;
}
#endif
