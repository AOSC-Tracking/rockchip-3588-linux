...
static void hdmirx_update_bits(struct rk_hdmirx_dev *hdmirx_dev, int reg,
			       u32 mask, u32 data)
{
...
static int wait_reg_bit_status(struct rk_hdmirx_dev *hdmirx_dev, u32 reg,
...
static void dma_idle_int_handler(struct rk_hdmirx_dev *hdmirx_dev,
				 bool *handled)
{
	struct hdmirx_stream *stream = &hdmirx_dev->stream;
	struct v4l2_device *v4l2_dev = &hdmirx_dev->v4l2_dev;
...
static void line_flag_int_handler(struct rk_hdmirx_dev *hdmirx_dev,
				  bool *handled)
{
	struct hdmirx_stream *stream = &hdmirx_dev->stream;
	struct v4l2_device *v4l2_dev = &hdmirx_dev->v4l2_dev;
